...
public function __construct(){
    ...
    try{
        ...
        /*          Creating connection to MySql. We will create an conexion type OBJECT
                    ...
                    $this->conexion_db = new PDO('mysql:host=localhost; dbname=theschool;charset=utf8', 'root', ''); //Conexion created
                    //echo 'Conexion OK <br>';
            ...
            /*         When there is an error in executing time (not because of typewritting mistake
                    ...
                    echo "Conexion to DB successful";
                }catch(Exception $e){
                    ...
                    die('Error: '.$e->getMessage().".<br> Error code: ".$e->getCode().".<br> Error is in line number: ".$e->getLine()); //There is also get code, get file and get line
